...
if ! [ -s "$NAME.phar" ] || [ "$(head -n 1 $NAME.phar)" == '<!DOCTYPE html>' ]; then
	...
	download_file "https://raw.githubusercontent.com/iTXTech/Genisys/${BRANCH}/LICENSE" > LICENSE
	download_file "https://raw.githubusercontent.com/iTXTech/Genisys/${BRANCH}/README.md" > README.md
	#download_file "https://raw.githubusercontent.com/PocketMine/PocketMine-MP/${BRANCH}/CONTRIBUTING.md" > CONTRIBUTING.md
	download_file "https://raw.githubusercontent.com/PeratX/php-build-scripts/${BRANCH}/compile.sh" > compile.sh
fi
